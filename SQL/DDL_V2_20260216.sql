...
CREATE DATABASE IF NOT EXISTS playasset_core
...
CREATE TABLE IF NOT EXISTS user_auth_credentials (
  ...
  CONSTRAINT fk_user_auth_credentials_user_id
...
CREATE TABLE IF NOT EXISTS asset_aliases (
  ...
  CONSTRAINT fk_asset_aliases_asset_id
...
CREATE TABLE IF NOT EXISTS watchlist_items (
  ...
  CONSTRAINT fk_watchlist_items_asset_id
    FOREIGN KEY (asset_id) REFERENCES assets (asset_id)
);
...
CREATE TABLE IF NOT EXISTS portfolio_accounts (
  ...
  CONSTRAINT fk_portfolio_accounts_portfolio_id
...
CREATE TABLE IF NOT EXISTS portfolio_positions (
  ...
  CONSTRAINT fk_portfolio_positions_account_id
    FOREIGN KEY (account_id) REFERENCES portfolio_accounts (account_id),
  CONSTRAINT fk_portfolio_positions_asset_id
    FOREIGN KEY (asset_id) REFERENCES assets (asset_id)
);
...
CREATE TABLE IF NOT EXISTS portfolio_transactions (
  ...
  CONSTRAINT fk_portfolio_transactions_account_id
    FOREIGN KEY (account_id) REFERENCES portfolio_accounts (account_id),
  CONSTRAINT fk_portfolio_transactions_asset_id
    FOREIGN KEY (asset_id) REFERENCES assets (asset_id)
);
...
CREATE TABLE IF NOT EXISTS market_price_candles (
  ...
  CONSTRAINT fk_market_price_candles_asset_id
    FOREIGN KEY (asset_id) REFERENCES assets (asset_id)
);
...
CREATE TABLE IF NOT EXISTS news_asset_mentions (
  ...
  CONSTRAINT fk_news_asset_mentions_article_id
    FOREIGN KEY (article_id) REFERENCES news_articles (article_id),
  CONSTRAINT fk_news_asset_mentions_asset_id
    FOREIGN KEY (asset_id) REFERENCES assets (asset_id)
);
...
CREATE TABLE IF NOT EXISTS news_sentiment_scores (
  ...
  CONSTRAINT fk_news_sentiment_scores_article_id
    FOREIGN KEY (article_id) REFERENCES news_articles (article_id)
);
...
CREATE TABLE IF NOT EXISTS alert_rules (
  ...
  CONSTRAINT fk_alert_rules_user_id
    FOREIGN KEY (user_id) REFERENCES users (user_id),
  CONSTRAINT fk_alert_rules_asset_id
    FOREIGN KEY (asset_id) REFERENCES assets (asset_id)
);
...
CREATE TABLE IF NOT EXISTS alert_events (
  ...
  CONSTRAINT fk_alert_events_user_id
    FOREIGN KEY (user_id) REFERENCES users (user_id),
  CONSTRAINT fk_alert_events_asset_id
    FOREIGN KEY (asset_id) REFERENCES assets (asset_id)
);
...
CREATE TABLE IF NOT EXISTS notification_deliveries (
  ...
  CONSTRAINT fk_notification_deliveries_alert_event_id
    FOREIGN KEY (alert_event_id) REFERENCES alert_events (alert_event_id)
);
